                                ...
                                <!-- Form to update the price, food name, and description -->
                                    ...
                                    <input type="hidden" name="foodID" value="<?php echo $foodID; ?>">
                                     <div class="mb-3">
                                         ...
                                         <input type="text" class="form-control" id="newFoodName" name="newFoodName" value="<?php echo $foodName; ?>" placeholder="Enter new food name" required>
                                          </div>
                                            <div class="mb-3">
                                            <label for="newPrice" class="form-label">New Price Per Item</label>
                                             <input type="text" class="form-control" id="newPrice" name="newPrice" value="<?php echo $pricePerItem; ?>" placeholder="Enter new price" required>
                                           </div>
                                          <div class="mb-3">
                                         <label for="newDescription" class="form-label">Description</label>
                                        <textarea class="form-control" id="newDescription" name="newDescription" placeholder="Enter new description" required><?php echo $description; ?></textarea>
                                             </div>
