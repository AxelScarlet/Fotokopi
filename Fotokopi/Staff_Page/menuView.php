            ...
            if ($res && mysqli_num_rows($res) > 0) {
                while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo $updateTime; ?></td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="updatePrice.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="newFoodName<?php echo $foodID; ?>" class="form-label">Food Name</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="newType<?php echo $foodID; ?>" class="form-label">Section</label>
                                            <input class="form-control" id="newType<?php echo $foodID; ?>" name="newType" value= "<?php echo $typeName?>" placeholder="Select Section" required>
                                        </div>
                                        <div class="mb-3"><!--new part typeName for category-->
                                            <label for="newImage<?php echo $foodID; ?>" class="form-label">Image Link</label>
                                            <input type="text" class="form-control" id="newImage<?php echo $foodID; ?>" name="newImage" value="<?php echo $menuPic; ?>" placeholder="Enter new image link" required>
                                        </div>
