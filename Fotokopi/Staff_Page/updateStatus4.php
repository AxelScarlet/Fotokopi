<?php
    ...
    $sql = "UPDATE ordermenu SET orderStatus = 'Refund Request Accepted' WHERE orderID = '$id'";
    ...
    if ($res) {
        ...
        $_SESSION['update']= "<div class='alert alert-success alert-dismissible'><button type='button' class='btn-close' data-bs-dismiss='alert'></button>Refund Request Updated Successfully</div>";
