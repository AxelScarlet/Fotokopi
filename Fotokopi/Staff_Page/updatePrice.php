...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST['foodID'], $_POST['newPrice'], $_POST['newFoodName'], $_POST['newDescription'])) {
        ...
        $stmt = $conn->prepare("UPDATE menu SET foodPrice = ?, foodName = ?, foodDetails = ? WHERE foodID = ?");
        $stmt->bind_param("dssi", $price, $foodName, $description, $id);
        $res = $stmt->execute();
