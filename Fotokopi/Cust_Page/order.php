...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed">
    <div class="container-fluid">
        <ul class="navbar-nav ms-auto me-auto">
            <li class="nav-item">
                <a class="btn btn-warning mx-2" href="#section1">Section 1</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-warning mx-2" href="#section2">Section 2</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-warning mx-2" href="#section3">Section 3</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-warning mx-2" href="#section4">Section 4</a>
            </li>
        </ul>
    </div>
</nav>
...
<div id="section1" class="container-fluid bg-danger" style="padding:50px 20px;">
    <h1>Promotion</h1><br>
    <div>
        <?php
...
<div id="section2" class="container-fluid bg-warning" style="padding:50px 20px;">
    <h1>Coffee</h1><br>
    <div>
        <?php
...
<div id="section3" class="container-fluid bg-info" style="padding:50px 20px;">
    <h1>Pastry</h1><br>
    <div>
        <?php
...
<div id="section4" class="container-fluid bg-secondary" style="padding:50px 20px;">
    <h1>Cakes</h1><br>
    <div>
        <?php
