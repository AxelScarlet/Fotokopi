...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2024 at 10:46 PM
...
INSERT INTO `menu` (`foodID`, `foodName`, `foodDetails`, `foodPrice`, `menuPic`, `updateTime`, `typeName`) VALUES
(1, 'Mocha', 'Air mocha milo', 5.00, 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Cappuccino_at_Sightglass_Coffee.jpg/640px-Cappuccino_at_Sightglass_Coffee.jpg', NULL, 'Coffee'),
(2, 'Spicy Crispy Chicken', 'Ignite your taste buds with Spicy Crispy Chicken: Fiery, flavorful perfection. Hand-selected, seasoned, and fried to crispy satisfaction. Experience bold, spicy bliss. Try it today and savor the heat.', 6.00, 'https://www.vegrecipesofindia.com/wp-content/uploads/2018/02/cafe-style-hot-coffee-recipe-1.jpg', NULL, 'Coffee'),
(3, 'Cheesy Crispy Chicken', 'Savor Cheesy Crispy Chicken: Crispy, golden perfection meets gooey, melted cheese. Indulge in the irresistible blend of flavors. Try it today and experience cheesy delight.', 6.00, NULL, NULL, 'Coffee'),
(4, 'Original Crispy Chicken Popcorn', 'Original Crispy Chicken Popcorn: Bite-sized flavor bombs. Crispy, juicy, and oh-so-addictive. Experience the ultimate snacking sensation. Try it today and indulge in popcorn perfection.', 4.00, NULL, NULL, 'Coffee'),
...
(12, 'BBQ Sauce', 'BBQ sauce, short for barbecue sauce, is a mouthwatering condiment that brings a delightful combination of smoky, sweet, and tangy flavors', 3.00, NULL, NULL, 'Pastry');
